...
void DrawTriangle::createGraphicsPipeline()
{
	...
	//info for both shaders
	VkPipelineShaderStageCreateInfo shaderStages[] = { vertShaderStageInfo, fragShaderStageInfo };

	//input for the vertex TODO: implement passing of data to vertex
	...
	//Info for how primitives are to be rendered : Chosen as triangles with vertices with no repetititon
	...
	*/
	...
	//Dynamic state : change parts of the pipeline without recreating it
	...
	pipelineInfo.pDepthStencilState = nullptr;			//FOR NOW!!!!!!!!!!!
	pipelineInfo.pColorBlendState = &colorBlending;
	pipelineInfo.pDynamicState = nullptr;				//FOR NOW!!!!!!!!!!!
	...
	{
		throw std::runtime_error("Failed to create a graphics pipeline!!!!!!!!AAAAAAAAAAAAAAHHHHHHHHHHHHHH");
	}
